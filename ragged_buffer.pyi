...
class RaggedBuffer(Generic[ScalarType]):
    ...
    @classmethod
    def from_flattened(
        cls, flat_items: NDArray[ScalarType], sequence_lenghts: NDArray[np.int64]
    ...
    @overload
    def __getitem__(self, i: int) -> NDArray[ScalarType]: ...
    @overload
    def __getitem__(self, indices: NDArray[np.int64]) -> RaggedBuffer[ScalarType]: ...
